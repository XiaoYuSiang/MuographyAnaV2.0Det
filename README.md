...
02.Changing the path of floder which "input file" and want to do analysis for:
...
04.The path of the folder which put the analysis "program files"
  path_Mac:   
    default: ./Macro/

05.Change the Data name want to be researched!!
  name_Raw:
    default: "2022*_Mu"
...
06.Change the operation mode for you want:
...
07.Set if you want to skip some block of program:
...
08.Select the program want to be used:
