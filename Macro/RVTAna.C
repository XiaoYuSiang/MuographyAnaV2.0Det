...
void RVTAna() {
  ...
  for(int i1=0;i1<NumBD;i1++){
    ...
    L[i1] = new TLegend(0.105+0.79/(NumBD*1.)*i1,0.82,0.105+0.79/(NumBD*1.)*(1+i1),0.88);
    //L[i1]->SetNColumns(4);
    L[i1]->SetLineColorAlpha (0, 1.00);
    L[i1]->SetFillColorAlpha (0, 1.00);
  ...
  for(int i1=0;i1<NumBD;i1++){
    ...
    AxisID[i1]->SetTitleSize(0.02);
    AxisID[i1]->SetLabelSize(0.02);
    AxisID[i1]->Draw();
  }
